...
# Purpose: Computes the total chocolate desired by the user
# Acknowledgement: Modified from original code written by Dr. Jan Pearce
#
...
num_boxes = int(input("How many chocolate boxes would you like? "))
